...
const EMAIL = 'migangel761+vigilantea2@gmail.com'
const PASSWORD = process.env.TEST_PASSWORD

if (!PASSWORD) {
  console.error('ERROR: No se encontró TEST_PASSWORD.')
  process.exit(1)
}
...
console.log('')
console.log('==========================================')
console.log(' CREACIÓN CONTROLADA - VIGILANTE A2')
console.log('==========================================')
console.log('')
